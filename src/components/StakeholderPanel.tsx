      ...
      <div className="glass-panel min-w-0 p-4 sm:p-5">
        ...
        <div className="mt-5 grid gap-3">
          {evaluation.stakeholderImpacts.map((impact) => (
            <article key={impact.stakeholder} className={cn("min-w-0 rounded-lg border p-4", impactTone[impact.tone])}>
      ...
      <div className="glass-panel min-w-0 p-4 sm:p-5">
        ...
        <div className="mt-5 grid gap-3">
          {evaluation.governanceChecklist.map((item) => (
            <article key={item.label} className="min-w-0 rounded-lg border border-white/10 bg-white/[0.04] p-4">
